...
function OfModelsPageContent() {
  const router = useRouter();
  const dispatch = useAppDispatch();
  const searchParams = useSearchParams();

  const { allProfiles, filteredProfiles, loading, error, lastFetchTime } = useAppSelector(
  ...
  useEffect(() => {
    const userType = searchParams.get('userType') || 'of-model';
    dispatch(
      setFilters({
        ...
        <div className="relative container mx-auto max-w-6xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-text-inverse mb-4 max-md:flex max-md:flex-col">
              Alchemyst
              <span className="bg-[url('/graphic/scratch.png')] bg-cover bg-center bg-no-repeat py-2 px-2"> of-models </span>
            </h1>
          </motion.div>
                ...
                <div className="flex max-md:flex-col gap-2">
                  ...
                  <div className="flex-1 relative">
                    <div className="relative">
                      ...
                      <input
                        type="text"
                        placeholder="Search of-models by location, services, body type..."
                        value={searchQuery}
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <div className="flex items-center gap-4 text-sm text-muted-foreground">
              <span>{displayProfiles.length} of-models found</span>
              {lastFetchTime && (
                <>
                  <span>•</span>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            <p className="text-muted-foreground text-lg">
              {allProfiles.length === 0 ? 'No of-models available. Check back later!' : 'No of-models found. Try adjusting your filters.'}
            </p>
