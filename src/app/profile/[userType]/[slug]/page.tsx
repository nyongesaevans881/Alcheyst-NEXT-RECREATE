...
// Note: This page is client component, so metadata must be added via next/head in layout or parent
// For full SEO, consider making this a server component or adding metadata in layout
...
export default function ProfileDetailsPage({ params, searchParams }: PageProps) {
  ...
  // Note: ID is now passed via query parameter (?id=...) instead of being embedded in slug
