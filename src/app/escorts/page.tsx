...
export default function EscortsPage() {
  ...
  // Set userType to escort on mount and fetch profiles - runs once
  useEffect(() => {
    // Only set filters and fetch on initial mount
    const userType = searchParams.get('userType') || 'escort';
    dispatch(
      setFilters({
                ...
                <div className="flex max-md:flex-col gap-2">
                  ...
                  <div className="flex-1 relative">
                    <div className="relative">
                      ...
                      <input
                        type="text"
                        placeholder="Search escorts by location, services, body type..."
                        value={searchQuery}
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <div className="flex items-center gap-4 text-sm text-muted-foreground">
              <span>{displayProfiles.length} escorts found</span>
              {lastFetchTime && (
                <>
                  <span>•</span>
          ...
          <div className="text-center py-20">
            <p className="text-muted-foreground text-lg">
              {allProfiles.length === 0
                ? 'No escorts available. Check back later!'
                : 'No escorts found. Try adjusting your filters.'}
            </p>
